<template>
  <VueFinalModal
    ...
    content-class="max-w-6xl modal-box opacity-100 max-h-[90vh] overflow-y-auto"
  >
      ...
      <div v-if="activeTab === 0">
        ...
        <div v-else class="space-y-2">
          <div 
            ...
            :key="track.id"
            class="flex items-center p-3 rounded-lg hover:bg-base-200 cursor-pointer"
            @click="playTrack(track)"
          >
            <div class="avatar mr-3">
              <div class="w-12 h-12 rounded">
                <img 
                  :src="track.artwork_url || 'https://picsum.photos/seed/track-' + track.id + '/200/200.jpg'" 
                  :alt="track.title"
                  class="w-full h-full object-cover"
                />
              </div>
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-sm text-gray-500 truncate">{{ track.user.username }}</p>
            </div>
            ...
            <div class="card-body p-4">
              <div class="flex items-center space-x-3">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-sm text-gray-500 truncate">{{ artist.full_name || artist.username }}</p>
            ...
            <div class="card-body p-4">
              <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                  ...
                  <div class="mt-2">
                    <p class="text-xs text-gray-500">{{ $t("cloudie.user.onTrack") }}: {{ comment.track.title }}</p>
                  </div>
                </div>
              </div>
            </div>
